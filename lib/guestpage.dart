          ...
          children: [
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) => _GuestVenueCard(venue: filteredVenues[index]),
                      );
                    },
                  ),
                ),
            ...
            Positioned(
              ...
              child: FloatingNavBar(
                currentIndex: 1,
                onTap: (index) {
                  if (index == 0) Navigator.push(context, MaterialPageRoute(builder: (_) => const SavedPageGuest()));
                  if (index == 2) Navigator.push(context, MaterialPageRoute(builder: (_) => const ProfileGuest()));
                },
              ),
            ),
          ],
  ...
  Widget _buildCarouselItem(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(image: AssetImage(welcomeImages[index]), fit: BoxFit.cover),
      ),
      child: Container(
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20),
...
class _GuestVenueCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => GuestBookingPage(venue: venue))),
        borderRadius: BorderRadius.circular(25),
        child: Column(
          children: [
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(venue.price, style: const TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 14)),
                  ),
                ),
              ],
            ),
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(venue.name, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF102C57))),
                        const SizedBox(height: 4),
                        Text(venue.info, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.grey[600], fontSize: 13)),
                      ],
                    ),
                  ),
                  const CircleAvatar(
